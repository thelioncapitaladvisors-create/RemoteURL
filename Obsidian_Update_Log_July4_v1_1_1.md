...
- **NIFTY Index Classification Fix**: Fixed a symbol classification discrepancy where NIFTY index tickers (`NIFTY` and `NIFTY1!`) were mapped to the `'other'` category instead of `'nifty'` because the hardcoded Nifty lists only contain individual equity components (like `TCS`, `INFY`). Patched `getMarket`, `getMarketFromSignal`, and `getMarketCategory` across [page.tsx](file:///Users/vishant/Documents/Project/Tv-Alert-Mobile/src/app/page.tsx), [index.html](file:///Users/vishant/Documents/Project/TLCS_Website_Deploy/index.html), [scanner.js](file:///Users/vishant/Documents/Project/TLCS_Website_Deploy/scanner.js), and [trade-metrics.js](file:///Users/vishant/Documents/Project/TLCS_Website_Deploy/trade-metrics.js) to resolve this, allowing closed Nifty signals to display and filter correctly on Nifty tabs.
