...
- **Insights Tab Terminology**: Renamed the "STRATEGY INSIGHTS" sub-header to "SIGNAL INSIGHTS" on the Insights tab to better reflect the nature of the data provided.
