...
url = "https://dwepduvhzuhzeehbeaaz.supabase.co/rest/v1/signals?status=in.(ACTIVE%20LIMIT,Active%20Limit,Active,OPEN,Open)"
headers = {
...
try:
    with urllib.request.urlopen(req) as response:
        ...
        print(f"Healed {len(res_data)} stuck trades.")
